	...
	$.fn.zySearch = function(options,param){
		...
		return this.each(function(){
			...
			this.createHtml = function(){
				...
				html += '<input id="searchInput" class="search-input" type="text" placeholder="输入关键字搜索" value="'+keyword+'">';
				html += '<button class="search-btn btn" onclick="searchProduct();">搜索</button>';
...
function searchProduct(){
	...
	window.location.href = BASE_URL + "?keyword=" + searchInput;
}
