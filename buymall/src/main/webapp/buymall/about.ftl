  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="jumbotron">
        <h1>关于囤货网</h1>
        <p>1、质量有保证，是我们宗旨；</p>
        <p>2、我们只做信息传递平台，所有交易，均在淘宝，天猫，京东等各大商城完成；</p>
        <p>3、用户满意，是我们的目标；</p>
        <p>4、带给用户实实在在的优惠，是我们的追求；</p>
        <p>5、不遗余力的让每个用户满意，是我们的未来；</p>
        <p>6、所有会员资料均属于隐私，本站不会泄露任何会员资料；</p>
        <p>7、我们欢迎每一位用户为我们提出您宝贵的意见；</p>
        <p>8、联系我，email:<code>chinazhoudong@gmail.com</code>。</p>
        <p>9、联系我，手机:<code>18511833392</code>。</p>
      </div>
      <!-- 地脚信息 -->
