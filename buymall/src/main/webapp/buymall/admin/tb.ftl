		...
		<div class="jumbotron">
		    ...
		    <form role="form" id="f">
			   <div class="form-group">
			      <select class="form-control" id="tbType">
			   ...
			   <div class="form-group">
			      <div class="form-group">
				    ...
				    <textarea class="form-control" rows="3" id="tbUrl"></textarea>
				  </div>
			   </div>
			   
			   <button type="button" class="btn btn-primary" onclick="doTBSubmit();" style="width:100%;">提交</button>
			</form>
			<!-- form end -->
